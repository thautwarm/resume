...
\begin{itemize}
  \item Created an implementation of dynamically loading and updating distributed data schema for Microsoft GraphEngine
  ...
  \item Created a LLVM IR builder framework in .NET side, which is introduced into a future/extended version of GraphEngine to achieve JIT support
